<x-layout>
    ...
    @if($errors->any())
        <div class="alert alert-danger">
            Some fields (highlighted in red) contains errors, please correct them.
        </div>
    @endif
    ...
    <form action="
        ...
        <div class="tab-content pt-3">
            <div class="tab-pane fade show active" id="base-tab-pane" role="tabpanel" aria-labelledby="base-tab"
                ...
                <div class="mb-3">
                    <label for="horizontal_size" class="form-label">
                        Horizontal size
                ...
                <div class="mb-3">
                    <label for="vertical_size" class="form-label">
                        Vertical size
                        <span class="text-danger">*</span>
                    </label>
            ...
            <div class="tab-pane fade" id="additional-tab-pane" role="tabpanel" aria-labelledby="additional-tab"
                 tabindex="0">
                <div class="mb-3">
                    <label for="hw_version" class="form-label">
                        HW version
                        <span class="text-danger">*</span>
                    </label>
                ...
                <div class="mb-3">
                    <label for="sw_version" class="form-label">
                        SW version
                        <span class="text-danger">*</span>
                    </label>
            ...
            <div class="tab-pane fade" id="timing-tab-pane" role="tabpanel" aria-labelledby="timing-tab"
                 tabindex="0">
                <div class="mb-3">
                    <label for="pixel_clock" class="form-label">
                        Pixel clock
                        <span class="text-danger">*</span>
                    </label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="horizontal_pixels" class="form-label">
                                Horizontal pixels
                                <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="horizontal_blank" class="form-label">
                                Horizontal blank
                                <span class="text-danger">*</span>
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="vertical_lines" class="form-label">
                                Vertical lines
                                <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="vertical_blank" class="form-label">
                                Vertical blank
                                <span class="text-danger">*</span>
                            </label>
            ...
            <div class="tab-pane fade" id="extra-timing-tab-pane" role="tabpanel"
                ...
                <div class="mb-3">
                    <label for="extra_pixel_clock" class="form-label">
                        Pixel clock
                        <span class="text-danger">*</span>
                    </label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="extra_horizontal_pixels" class="form-label">
                                Horizontal pixels
                                <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="extra_horizontal_blank" class="form-label">
                                Horizontal blank
                                <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="extra_horizontal_front_porch" class="form-label">
                        ...
                        <div class="mb-3">
                            <label for="extra_horizontal_sync_width" class="form-label">
                        ...
                        <div class="mb-3">
                            <label for="extra_horizontal_image_size" class="form-label">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="extra_vertical_lines" class="form-label">
                                Vertical lines
                                <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="extra_vertical_blank" class="form-label">
                                Vertical blank
                                <span class="text-danger">*</span>
                            </label>
        ...
        <p class="text-secondary mt-3">Fields marked by <span class="text-danger">*</span> are required.</p>
