...
class InfotainmentProfileRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'extra_horizontal_front_porch.required_if_accepted' => $requiredMessage,
            'extra_horizontal_sync_width.required_if_accepted' => $requiredMessage,
            'extra_horizontal_image_size.required_if_accepted' => $requiredMessage,
            'extra_vertical_lines.required_if_accepted' => $requiredMessage,
            'extra_vertical_blank.required_if_accepted' => $requiredMessage,
            'extra_vertical_front_porch.required_if_accepted' => $requiredMessage,
            'extra_vertical_sync_width.required_if_accepted' => $requiredMessage,
            'extra_vertical_image_size.required_if_accepted' => $requiredMessage,
        ];
    }
}
