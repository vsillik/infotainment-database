...
class DetailedTimingDataBlock extends AbstractDataBlock
{
    ...
    public function toBytes(): array
    {
        ...
        return [
            ...
            ($pixelClock & 0b1111111100000000) >> 8,
            $this->horizontalAddressablePixels & 0b11111111,
            $this->horizontalBlankingPixels & 0b11111111,
            (($this->horizontalAddressablePixels & 0b111100000000) >> 4) | (($this->horizontalBlankingPixels & 0b111100000000) >> 8),
            $this->verticalAddressableLines & 0b11111111,
            $this->verticalBlankingLines & 0b11111111,
            (($this->verticalAddressableLines & 0b111100000000) >> 4) | (($this->verticalBlankingLines & 0b111100000000) >> 8),
            ...
            (($this->horizontalFrontPorchPixels & 0b1100000000) >> 2) | (($this->horizontalSyncWidthPixels & 0b1100000000) >> 4) | (($this->verticalFrontPorchLines & 0b110000) >> 2) | (($this->verticalSyncWidthLines & 0b110000) >> 4),
            $this->horizontalImageSizeMillimeters & 0b11111111,
            $this->verticalImageSizeMillimeters & 0b11111111,
            (($this->horizontalImageSizeMillimeters & 0b111100000000) >> 4) | (($this->verticalImageSizeMillimeters & 0b111100000000) >> 8),
